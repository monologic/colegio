...
(function($) {
	$.fn.extend({
		...
		$('#' + uniqueId).prepend('<div class="monthly-header"><div class="monthly-header-title"></div><a href="#"  class="monthly-prev"></a><a href="#" class="monthly-next" onclick="cambiarm()"></a></div>').append('<div class="monthly-event-list"></div>');

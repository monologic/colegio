app.controller('novedadesController', function($scope,$http) {
    
    $scope.get = function () {
        $http.get('getNovedades').then(function successCallback(response) {
                data = response.data;
                for(i in data){
    ...
    $scope.firstNovedades = function () {
        $http.get('getNovedadesIndex').then(function successCallback(response) {
                data = response.data;
                for(i in data){
                    rs=data[i].fecha;
                    $scope.fe = rs.split(' ');
    ...
    $scope.plus = function (data) {
        ...
        $scope.id = data.id;
        $scope.formUrl = 'novedades/' + data.id;

	    		...
	    		<div class="formulariok">
	    			<form role="form" method="POST" action="{{ url('app/noticias') }}" accept-charset="UTF-8" enctype="multipart/form-data">
						...
						<div class="form-group">
						    ...
						    <textarea  id="" cols="50" rows="10" name="cuerpo" class='edit' style=""></textarea>
						</div>
						<div class="form-group">
						    <label for="fecha">Fecha de publicación</label>
						    <input type="datetime-local" class="form-control" id="fecha" placeholder="2016-01-01 12:00" name="fecha" required>
						</div>
